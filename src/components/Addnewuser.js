...
import {AppBar,Toolbar,makeStyles, Dialog,
  DialogTitle,
  DialogContent,
    ...
    return (
      ...
      <Toolbar>
          ...
          <div className={classes.navlinks}>
            <Link to="Users" className={classes.user}>
              User
            </Link>
        ...
        />
         ...
         <NavLink className="edit" strict to="/events/">
  Edit 
</NavLink>
  ...
  Edit 
      ...
      <div>
        <TextField className="textfield"
          ...
          helperText="Please select Main Org"
        >
        ...
        <Button className="save" variant="contained" href="Preferences">
          Save
        </Button> 

      <Button className="cancel" variant="contained" href="Preferences">
        Cancel
      </Button> 

      <NavLink className="remove" strict to="/events/">
